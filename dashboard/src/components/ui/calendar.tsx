  ...
  return (
    <BentoCard height="h-auto" linkTo={bookingLink}>
      <div className=" grid h-full  gap-5">
        <div className="">
          <h2 className="mb-4 text-lg md:text-3xl font-semibold text-slate-900 dark:text-white">
            Any questions about Design?
          </h2>
          <p className="mb-2 text-xs md:text-md text-slate-500 dark:text-slate-400">
            Feel free to reach out to me!
          </p>
          <Button className="mt-3 rounded-2xl bg-indigo-600 hover:bg-indigo-700 text-white font-semibold">Book Now</Button>
        </div>
